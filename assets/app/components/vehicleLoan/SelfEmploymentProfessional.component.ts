...
@Component({
    selector: 'SelfEmploymentProfessional-details',
    templateUrl: './SelfEmploymentProfessional.component.html'
})
export class SelfEmploymentProfessionalComponent implements OnInit{
