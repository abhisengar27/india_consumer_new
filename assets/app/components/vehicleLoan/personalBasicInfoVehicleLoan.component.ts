...
@Component({
    ...
    templateUrl: './personalBasicInfoVehicleLoan.component.html',
    providers: [DatePipe]
})
export class PersonalBasicInfoVehicleLoan implements AfterViewInit, OnInit {
   toggle: boolean;
    verifyEmailOtp;
    newverifyEmailOtp;
    emailTicks = 60;
    ...
    constructor(private oaoService: OAOService, private router: Router, private route: ActivatedRoute, private datePipe: DatePipe) {
        ...
        //from vehicleLoanDetails

        this.model.vehicleLoanType=this.model1.vehicleLoanType;
        this.model.vehicle_make=this.model1.vehicle_make;
        this.model.vehicle_onroad_price=this.model1.vehicle_onroad_price;
        this.model.employertype=this.model1.employertype;
        this.model.netIncome=(parseInt(this.model1.netIncome));
        this.model.Work_experience=this.model1.Work_experience;
        this.model.noMonths=this.model1.noMonths;
        ...
        if (this.model.maritalStatus === null || this.model.maritalStatus === '' || this.model.maritalStatus ===undefined) {
            this.model.maritalStatus = '0';
        }
          if (this.model.gender === null || this.model.gender === '' || this.model.gender ===undefined) {
            this.model.gender = '0';
        }
